...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Ensure you collect static files to this directory
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'frontend/build/static'),  # Ensure build static files are included
]
